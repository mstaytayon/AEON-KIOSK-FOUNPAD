...
public class SyncDataGuestNameService extends AsyncTask<Void, Void, Exception> {

    private final SyncDataGuestNameListener listener;
    private int id,referenceID,type;
    private String referenceNumber,customerName,transactionDateTime;
    private final String url;

    public interface SyncDataGuestNameListener {
    ...
    public SyncDataGuestNameService(SyncDataGuestNameListener listener, String url,
                                    int id,int referenceID,String referenceNumber,String customerName,String transactionDateTime,int type) {

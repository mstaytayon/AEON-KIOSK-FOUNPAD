...
//        });
        ...
        for (int i = 0; i < rates.size(); i++) {
            ...
            button.setText(Html.fromHtml(rates.get(i).getDescription() + "<br><br>" +"PHP "+PlayTimeRate));
//            button.setText(Html.fromHtml (rates.get(i).getDescription() +"<br><br>"+"PHP "+PlayTimeRate)) ;
            ...
            if (count == 1) {
                button.setBackground(ContextCompat.getDrawable(this, R.drawable.img1));
            }else if (count == 2){
                button.setBackground(ContextCompat.getDrawable(this, R.drawable.img2));
            }else if (count == 3){
                button.setBackground(ContextCompat.getDrawable(this, R.drawable.img3));
                count = 0;
            }
